...
class GenderChart extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      () async {
        try {
          final res = await ReportService.getGenderCounts();
          data.value = res;
        } catch (e) {
          debugPrint("Gender Chart Error: $e");
        } finally {
          loading.value = false;
        }
      }();
    ...
    return Column(
      ...
      children: [
        ...
        if (selectedTab.value == "table")
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 10),
            child: _GenderTable(data: data.value),
          ),
...
//
//=====================================================
// 🔹 FULL-WIDTH GENDER TABLE
//=====================================================
//
class _GenderTable extends StatelessWidget {
  final List<Map<String, dynamic>> data;

  const _GenderTable({required this.data});
...
//
//=====================================================
// 🔹 TAB BUTTON (same style as job options tab)
//=====================================================
//
